...
export const STAND_GUIDES = [
  { id:"g1", type:"stand",   name:"銀座 数寄屋橋",        area:"東京都心", emoji:"🏙️", tags:["定番","夜強い","長距離多い"],      peak:"🌙 夜〜深夜◎",    lineup:"一方通行に沿って1列。前詰め厳守。係員22時以降不在。",          tips:["21時以降が回転早い","歌舞伎座帰り18時前後が狙い","雨の日は単価も上がる"],                                               caution:"昼間は回転遅い。周辺ひと流しの方が効率的。",                                                                                       rating:4.5, reviews:42, demandScore:4.6 },
  { id:"g2", type:"stand",   name:"新橋駅 SL広場口",      area:"東京都心", emoji:"🚂", tags:["終電後狙い","短距離注意"],         peak:"🌙 19〜24時◎",    lineup:"SL側に1列縦隊。烏森口側の2番乗り場も確認を。",                tips:["終電後0時30分〜需要爆発","金曜21時から並んでも稼げる","烏森口側が穴場"],                                                        caution:"短距離が多い時間帯は効率低下。",                                                                                                    rating:4.3, reviews:58, demandScore:4.4 },
  { id:"g3", type:"stand",   name:"六本木ヒルズ",          area:"東京都心", emoji:"🌆", tags:["高単価","深夜強","外国人多"],      peak:"🌙 深夜◎◎",       lineup:"地下タクシーベイに1列。係員誘導に従う。",                       tips:["深夜2時以降が最効率","外国人客は地図を見せてもらう","週末は15分前に到着推奨"],                                                    caution:"深夜1時前は空回りになりがち。",                                                                                                     rating:4.7, reviews:37, demandScore:4.8 },
  { id:"g4", type:"stand",   name:"新宿駅 西口",           area:"東京都心", emoji:"🗼", tags:["大型乗り場","朝も使える"],         peak:"🕐 朝◎ 🌙 夜◎",  lineup:"1〜4番乗り場に分かれる。4番は神奈川方面が多い。",              tips:["朝7〜9時も稼げる数少ない乗り場","4番で横浜・川崎方面の長距離が出る"],                                                          caution:"昼間は近距離ばかり。",                                                                                                              rating:4.1, reviews:51, demandScore:4.3 },
  { id:"g5", type:"stand",   name:"東京駅 丸の内南口",     area:"東京都心", emoji:"🚅", tags:["ビジネス客","高単価","朝夕強い"],  peak:"☀️ 朝夕◎◎",      lineup:"丸の内南口を出て右手。誘導員常駐。",                            tips:["朝7〜9時のビジネス客は空港・郊外の長距離が多い","新幹線帰りはトランクを先に開けると好印象","外国人観光客も多い"],                 caution:"行き先を断ることは原則禁止。乗車拒否にならないよう注意。",                                                                         rating:4.4, reviews:44, demandScore:4.5 },
  { id:"g6", type:"stand",   name:"横浜駅 西口",           area:"横浜",     emoji:"🏯", tags:["昼夜安定","神奈川広域"],           peak:"☀️ 昼○ 🌙 夜◎",  lineup:"西口ロータリー。1番一般客、2番予約・配車アプリ客。",            tips:["神奈川県内の長距離が出やすい","夕方17〜19時は回転が早い"],                                                                         caution:"東口と西口で乗り場が異なる。",                                                                                                      rating:4.2, reviews:33, demandScore:3.9 },
  { id:"g7", type:"stand",   name:"みなとみらい クイーンズスクエア", area:"横浜", emoji:"🎡", tags:["観光客多","週末強い"],      peak:"🌙 夜○（週末◎◎）",lineup:"クイーンズスクエア東棟地下1階。イベント時係員誘導あり。",   tips:["コンサート・花火後は需要爆発","観光客は遠方（都内・空港）ロングが多い"],                                                           caution:"みなとみらいは乗り場以外での乗降禁止区域が多い。",                                                                                  rating:4.0, reviews:19, demandScore:3.7 },
  { id:"a1", type:"airport", name:"羽田空港 第1T（JAL系）",area:"東京都心", emoji:"✈️", tags:["国内線","朝夕強"],                peak:"到着便多い 7〜9時・18〜21時", lineup:"到着ロビー1階の指定乗り場。係員誘導。空港タクシー協会ステッカー確認あり。", tips:["都内・横浜・川崎が行き先中心","深夜は需要激減","行き先は聞かれない。乗車拒否厳禁"],           caution:"待機場は無料だが時間制限あり。会社に確認を。", access:"首都高1号羽田線 空港中央ICから約5分。左レーンがタクシー専用。", flow:["空港中央ICで降りる","タクシー専用レーン左へ","待機場で待機","係員の呼び出しで乗り場へ"], rating:4.3, reviews:67, demandScore:4.2 },
  { id:"a2", type:"airport", name:"羽田空港 第3T（国際線）",area:"東京都心",emoji:"🛫", tags:["外国人多","深夜強","ロング率高"],  peak:"深夜便到着後 1〜3時",         lineup:"到着ロビー1階。国際線到着に合わせた需要。係員常駐。",           tips:["深夜便後は高単価の長距離が多い","外国人客にはクレカ対応必須","都心・横浜方面など超ロングも"],                                        caution:"外国人客の行き先が不明確な場合は地図アプリを見せてもらう。", access:"第1・2Tとは少し離れている。専用ルートで進入。",               flow:["空港中央ICから第3T方面へ","国際線タクシー乗り場案内板に従う","待機場で待機後、係員誘導"], rating:4.4, reviews:45, demandScore:4.6 },
  { id:"a3", type:"airport", name:"成田空港 第1T",          area:"千葉",     emoji:"🛫", tags:["超ロング","有料待機"],             peak:"国際線到着便に依存。昼・夕・深夜に波", lineup:"到着ロビー1階外。南・北ウイングで乗り場が異なる。到着便のウイングを事前確認。", tips:["都内まで15,000〜20,000円が相場","外国人客が多い。英語あいさつは用意","帰りに都内で客を拾うルートを計算"],             caution:"待機場は有料。長時間待機は費用対効果を計算すること。",       access:"東関東自動車道 成田ICから約15分。タクシー専用レーン必須。",    flow:["成田ICから案内板に従い進入","有料待機場に入る（30分以降課金）","係員の無線連絡で乗り場へ"], rating:4.1, reviews:43, demandScore:4.0 },
  { id:"a4", type:"airport", name:"関西国際空港",            area:"大阪",     emoji:"🛫", tags:["連絡橋通行料","外国人多"],         peak:"国際線到着便に依存。深夜が多い",      lineup:"到着ロビー1階。国際線到着口前の乗り場。係員常駐。",              tips:["大阪市内まで約1時間・6,000〜8,000円が相場","連絡橋通行料は乗客負担（往復約1,500円）","乗車前に通行料を説明しておくとトラブル防止"], caution:"連絡橋通行料の精算を乗車前に説明しておくこと。",              access:"阪神高速湾岸線 りんくうJCTから連絡橋経由。タクシー専用路で進入。", flow:["りんくうJCTから関西空港方面へ","連絡橋を渡りターミナル前へ","タクシー待機場（有料）に入る","係員誘導で乗り場へ"], rating:3.9, reviews:22, demandScore:3.6 },
];
