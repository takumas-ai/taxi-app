    ...
    <Card style={{ marginBottom:14, padding:"12px 16px" }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:6 }}>
        <div onClick={() => setOpen(p=>!p)} style={{ display:"flex", alignItems:"center", gap:8, cursor:"pointer", flexShrink:0 }}>
          <span style={{ fontSize:13, fontWeight:700, whiteSpace:"nowrap" }}>📅 カレンダー</span>
          {todayShift && !todayReport && (
            <span style={{ fontSize:10, backgroundColor:C.orange+"22", color:C.orange, fontWeight:700, padding:"3px 8px", borderRadius:99, lineHeight:1.3, textAlign:"center" }}>
              日報<br/>未入力
            </span>
          )}
          {todayShift && todayReport && (
